...
```shell
git clone https://github.com/dannyvassallo/thewhitenoise.git
cd thewhitenoise
```

From the "thewhitenoise" directory, install the gems by running the following:
```shell
bundle install
```

To fire up the server while in the "thewhitenoise" directory use this command:
```shell
middleman s
```
...
pwd
```
It should turn up "thewhitenoise"
